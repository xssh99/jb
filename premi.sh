...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To Julak Bantur Autoscript ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Auther : ${green}Julak Bantur® ${NC}${YELLOW}(${NC} ${green} Papada'an Store ${NC}${YELLOW})${NC}"
echo -e " © Recode By Julak Bantur Orang Banua${YELLOW}(${NC} 2024 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
restart_system() {
    ...
    TEXT="
<code>────────────────────</code>
<b>⚡AUTOSCRIPT JULAK BANTUR V5⚡</b>
<code>────────────────────</code>
...
wget raw.githubusercontent.com/xssh99/jb/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
